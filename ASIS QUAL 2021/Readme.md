...
Load binary to edb-debugger and place breakpoint at function t() then we will have table's address in RAX: [stack1](data/stack1)
...
Here we can see `rand()` is beind used
...
count is initialize as 31 because the program calls `z` 32 times
