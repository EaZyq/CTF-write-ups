...
c_file += "\";"
c_file += "\n\n"
c_file += "int main(int argc, char *argv[])\n"
c_file += "{\n"
c_file += "  void (*code)() = (void *)shellcode;\n"
c_file += "  code();\n"
c_file += "  exit(0);\n"
c_file += "}\n"
c_file += "\n"
...
Now we have an .c file that contain and run shellcode

Let's compile and throw it to IDA

Here we can see some interesting functions

![4](4.png)

Nothing here hint us about the flag

Below that the program unpack it self, after that some memory is xored with key `BEEF` and then program exit

![5](5.png)

So this sections must contain flag

Load the program to x64dbg, set bp and run
